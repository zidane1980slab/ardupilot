...
float AP_InertialSensor::get_pitch_angle_FT(void)
{
	return _backends[0]->get_pitch_angle_FT();
}

float AP_InertialSensor::get_yaw_angle_FT(void)
{
	return _backends[0]->get_yaw_angle_FT();
}
